...
function getReactVersion() {
  const parts = React76.version.split(".");
  return {
    major: +parts[0],
    minor: +parts[1],
    patch: +parts[2]
...
var ToastFade = React128.forwardRef((props, ref) => (0, import_jsx_runtime132.jsx)(Fade_default, {
  ...props,
  ref,
